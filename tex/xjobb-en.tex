...
\chapter{Results -- Overview in Graphs}\label{app:resultsgraphs}
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                table[y error index=2]{../results/singly_linked_list_best_enqueue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/singly_linked_list_avg_enqueue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/singly_linked_list_worst_enqueue.dat};
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/doubly_linked_list_best_enqueue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/doubly_linked_list_avg_enqueue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/doubly_linked_list_worst_enqueue.dat};
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/doubly_linked_list_avg_best_enqueue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/doubly_linked_list_avg_avg_enqueue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/doubly_linked_list_avg_worst_enqueue.dat};
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/array_priority_best_enqueue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/array_priority_avg_enqueue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2]{../results/array_priority_worst_enqueue.dat};
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/singly_linked_list_best_dequeue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/singly_linked_list_avg_dequeue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/singly_linked_list_worst_dequeue.dat};
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/doubly_linked_list_best_dequeue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/doubly_linked_list_avg_dequeue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/doubly_linked_list_worst_dequeue.dat};
    ...
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/doubly_linked_list_avg_best_dequeue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/doubly_linked_list_avg_avg_dequeue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/doubly_linked_list_avg_worst_dequeue.dat};
...
\begin{figure}[h!]
    \begin{adjustbox}{width=1\textwidth, center}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [style=thick, color=green, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/array_priority_best_dequeue.dat};

                \addplot [style=thick, color=blue, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/array_priority_avg_dequeue.dat};

                \addplot [style=thick, color=red, mark=o]
                plot [error bars/.cd, y dir = both, y explicit]
                table[y error index=2, y expr = \thisrowno{1}*1000]{../results/array_priority_worst_dequeue.dat};
    ...
    \label{}
\end{figure}
\chapter{Results -- Detailed in Tables}\label{app:resultsdetailed}
...
columns/2/.style={
    column name={Standard Deviation ($N=50$)},
    /pgf/number format/fixed zerofill,
    /pgfplots/table/preproc/expr={##1*1000},
    /pgf/number format/precision=2
},
