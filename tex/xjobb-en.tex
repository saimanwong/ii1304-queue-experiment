...
This study shows through experiment that the calculated theoretical space and
time complexity of a number of list implementations hold. The study also shows
that the priority queue data structure provides a time complexity better than
that of a double linked list with the low space complexity of the singly linked
list.
