...
%%% Denna paragrafen skulle kunna ändras
\skippara The following sections describe the implementation of the queues.
Additionally, we analyze the time complexity for the enqueue-operation.
We found the theoretical average case time complexity more challenging to analyze compared to the best and worst case.
Thus, we examine the best and worst cases in theory to interpret the average case for each implementation's enqueue-operation.
