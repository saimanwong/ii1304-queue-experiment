...
while [  $COUNTER_X -lt 50 ]; do
	...
	TOT_ELEMENT=$((10000 + $COUNTER_Y * 5000))
        ...
        ./obj/singly_linked_list $TOT_ELEMENT >> ./data/singly_linked_list_$TOT_ELEMENT
    
        echo "DOUBLY LINKED LIST - COUNTER: $COUNTER_X, TOT_ELEMENT: $TOT_ELEMENT" >> log
        ./obj/doubly_linked_list $TOT_ELEMENT >> ./data/doubly_linked_list_$TOT_ELEMENT
    
        echo "DOUBLY LINKED LIST AVG - COUNTER: $COUNTER_X, TOT_ELEMENT: $TOT_ELEMENT" >> log
        ./obj/doubly_linked_list_avg $TOT_ELEMENT >> ./data/doubly_linked_list_avg_$TOT_ELEMENT
    
        echo "ARRAY PRIORITY - COUNTER: $COUNTER_X, TOT_ELEMENT: $TOT_ELEMENT" >> log
        ./obj/array_priority $TOT_ELEMENT >> ./data/array_priority_$TOT_ELEMENT
